...
//	By getCode=By.cssSelector(".VerificationInput_verification_input_wrapper__o8Que > .relative > :nth-child(1)");
	...
	By getCode = By.xpath(
			"(//div[contains(@class,'flex relative align-center gap-3 leading-10 VerificationInput_verification_input__yYLC-')])//input[1]");

	By errLogin = By.xpath(
			"//p[text()=\"User has not completed with registration steps in GreenBox system, kindly finish and login.\"]");
